이 문서는 Rhino7 버전과 Rhino8 버전의 스크립트 설치법 전반을 포함합니다.
...
3. 파일 경로 안에 Elephant 폴더가 없다면 새로 생성해줍니다.
...
7. 툴바에 보이는 #NEW# 버튼을 좌틀릭하여 명령어를 업데이트 합니다.

8. #NEW#버튼을 우클릭하면 추가된 명령어 리스트를 볼 수 있습니다.

====== In Addition ======

이 코드들은 모두 자유롭게 사용하시면 됩니다.

수정하고 싶으면 수정하고, 배포하고 싶으면 배포하세요

====== A S ======

코드가 실행되지 않거나 추가했으면 하는 기능이 있을 경우 연락하면 됩니다.

E-Mail : 1208kjh4@gmail.com