...
최신 배포 버전은 GitHub Releases에서 받을 수 있습니다.

- [Elephant Tools v1.0.0 다운로드](https://github.com/1208kjh4-ai/Elephant/releases/tag/v1.0.0)

일반적인 GitHub `Code > Download ZIP` 대신 Release에 첨부된 `Elephant-v1.0.0.zip` 파일을 받는 것을 권장합니다.
...
1. GitHub Releases에서 `Elephant-v1.0.0.zip` 파일을 다운로드합니다.
...
4. 다운로드한 ZIP 파일의 압축을 풀고, `Elephant` 폴더를 Rhino scripts 폴더 안에 넣습니다.
